...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    protocol/common.proto\x1a\x1cs2clientprotocol/error.proto\"\xf0\x01\n\
    \x0cRequestQuery\x124\n\x07pathing\x18\x01\x20\x03(\x0b2#.SC2APIProtocol\
    .RequestQueryPathing\x12A\n\tabilities\x18\x02\x20\x03(\x0b2..SC2APIProt\
    ocol.RequestQueryAvailableAbilities\x12A\n\nplacements\x18\x03\x20\x03(\
    \x0b2-.SC2APIProtocol.RequestQueryBuildingPlacement\x12$\n\x1cignore_res\
    ource_requirements\x18\x04\x20\x01(\x08\"\xce\x01\n\rResponseQuery\x125\
    \n\x07pathing\x18\x01\x20\x03(\x0b2$.SC2APIProtocol.ResponseQueryPathing\
    \x12B\n\tabilities\x18\x02\x20\x03(\x0b2/.SC2APIProtocol.ResponseQueryAv\
    ailableAbilities\x12B\n\nplacements\x18\x03\x20\x03(\x0b2..SC2APIProtoco\
    l.ResponseQueryBuildingPlacement\"\x8a\x01\n\x13RequestQueryPathing\x12,\
    \n\tstart_pos\x18\x01\x20\x01(\x0b2\x17.SC2APIProtocol.Point2DH\0\x12\
    \x12\n\x08unit_tag\x18\x02\x20\x01(\x04H\0\x12(\n\x07end_pos\x18\x03\x20\
    \x01(\x0b2\x17.SC2APIProtocol.Point2DB\x07\n\x05start\"(\n\x14ResponseQu\
    eryPathing\x12\x10\n\x08distance\x18\x01\x20\x01(\x02\"2\n\x1eRequestQue\
    ryAvailableAbilities\x12\x10\n\x08unit_tag\x18\x01\x20\x01(\x04\"~\n\x1f\
    ResponseQueryAvailableAbilities\x123\n\tabilities\x18\x01\x20\x03(\x0b2\
    \x20.SC2APIProtocol.AvailableAbility\x12\x10\n\x08unit_tag\x18\x02\x20\
    \x01(\x04\x12\x14\n\x0cunit_type_id\x18\x03\x20\x01(\r\"z\n\x1dRequestQu\
    eryBuildingPlacement\x12\x12\n\nability_id\x18\x01\x20\x01(\x05\x12+\n\n\
    target_pos\x18\x02\x20\x01(\x0b2\x17.SC2APIProtocol.Point2D\x12\x18\n\
    \x10placing_unit_tag\x18\x03\x20\x01(\x04\"N\n\x1eResponseQueryBuildingP\
    lacement\x12,\n\x06result\x18\x01\x20\x01(\x0e2\x1c.SC2APIProtocol.Actio\
    ...
    \x03\x12\x03\n67\n\x0b\n\x04\x04\0\x02\x02\x12\x03\x0b\x028\n\x0c\n\x05\
    \x04\0\x02\x02\x04\x12\x03\x0b\x02\n\n\x0c\n\x05\x04\0\x02\x02\x06\x12\
    \x03\x0b\x0b(\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03\x0b)3\n\x0c\n\x05\
    \x04\0\x02\x02\x03\x12\x03\x0b67\nB\n\x04\x04\0\x02\x03\x12\x03\x0c\x021\
    \"5\x20Ignores\x20requirements\x20like\x20food,\x20minerals\x20and\x20so\
    \x20on.\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03\x0c\x02\n\n\x0c\n\x05\
    \x04\0\x02\x03\x05\x12\x03\x0c\x0b\x0f\n\x0c\n\x05\x04\0\x02\x03\x01\x12\
    \x03\x0c\x10,\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\x0c/0\n\n\n\x02\x04\
    \x01\x12\x04\x0f\0\x13\x01\n\n\n\x03\x04\x01\x01\x12\x03\x0f\x08\x15\n\
    \x0b\n\x04\x04\x01\x02\0\x12\x03\x10\x02,\n\x0c\n\x05\x04\x01\x02\0\x04\
    \x12\x03\x10\x02\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03\x10\x0b\x1f\n\
    \x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x10\x20'\n\x0c\n\x05\x04\x01\x02\0\
    \x03\x12\x03\x10*+\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\x11\x029\n\x0c\n\
    ...
    \x02\x01\x12\x03\x12*4\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03\x1278\no\
